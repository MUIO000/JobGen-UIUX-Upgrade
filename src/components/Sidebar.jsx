const Sidebar = ({ activeItem = 'Jobs Tracker' }) => {
  const menuItems = [
    { id: 'home', icon: 'home', label: 'Home' },
    { id: 'jobs-tracker', icon: 'briefcase', label: 'Jobs Tracker', active: true },
    { id: 'application-tracker', icon: 'clipboard', label: 'Application Tracker' },
    { id: 'resumes-builder', icon: 'document', label: 'Resumes Builder' },
    { id: 'cover-letter', icon: 'mail', label: 'Cover Letter' },
    { id: 'interview-prep', icon: 'chat', label: 'Interview Prep' },
    { id: 'my-workspace', icon: 'folder', label: 'My Workspace' }
  ]
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-3 shadow-lg">
          ...
          <div className="space-y-1 mb-3">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-white text-xs">Unlimited Resume</span>
            </div>
            <div className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-white text-xs">Unlimited Jobs</span>
            </div>
            <div className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-white text-xs">Unlimited AI Coach</span>
            </div>
          </div>
          <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-xs py-2 rounded-lg transition-colors">
            Get Hired Faster!
          </button>
        </div>
      </div> */}
