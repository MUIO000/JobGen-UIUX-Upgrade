        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 lg:justify-end">
              <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 p-1 rounded-full bg-slate-100">
                <div
                  onClick={() => setViewMode('board')}
                  className={`flex justify-center items-center flex-grow-0 flex-shrink-0 h-10 relative overflow-hidden gap-2 px-4 py-2 rounded-full cursor-pointer transition-all ${
                    viewMode === 'board' ? 'bg-white shadow-md' : 'hover:bg-white/50'
                  }`}
                >
                <svg
                  width="20"
                ...
                <p className={`flex-grow-0 flex-shrink-0 text-sm font-bold text-left ${viewMode === 'board' ? 'text-slate-800' : 'text-slate-600'}`}>Board View</p>
              </div>
              <div
              ...
              >
                ...
                <p className={`flex-grow-0 flex-shrink-0 text-sm font-bold text-left ${viewMode === 'list' ? 'text-slate-800' : 'text-slate-600'}`}>List View</p>
              </div>
              <div
                onClick={() => setViewMode('card')}
                className={`flex justify-center items-center flex-grow-0 flex-shrink-0 h-10 relative overflow-hidden gap-2 px-4 py-2 rounded-full cursor-pointer transition-all ${
                  viewMode === 'card' ? 'bg-white shadow-md' : 'hover:bg-white/50'
                }`}
              >
                <svg
                  width="20"
                ...
                <p className={`flex-grow-0 flex-shrink-0 text-sm font-bold text-left ${viewMode === 'card' ? 'text-slate-800' : 'text-slate-600'}`}>Card View</p>
              </div>
            </div>
